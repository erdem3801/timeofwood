  ...
  <script src="<?php echo base_url('admin-assets');  ?>/js/black-dashboard.min.js?v=1.0.0"></script><!-- Black Dashboard DEMO methods, don't include it in your project! -->
...
<script src="<?php echo base_url('admin-assets');  ?>/js/custome.js"></script>
